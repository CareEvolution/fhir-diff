...
export class KeyStore {
  ...
  public buildKeyPatient(
    ...
    return {
      ...
      identifier: pickIdentifier(patient.identifier),
    };
  }
  ...
  public buildKeyEncounter(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(encounter.identifier),
  ...
  public buildKeyCondition(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(condition.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyMedicationAdministration(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(medadmin.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyMedicationRequest(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(medRequest.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyMedicationDispense(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(medDispense.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyMedicationStatement(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(medStatement.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyMedication(
    ...
    return {
      ...
      identifier: pickIdentifier(medication.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyImmunization(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(immunization.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyProcedure(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(procedure.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyServiceRequest(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(serviceRequest.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyAllergyInterolerance(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(allergyIntolerance.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyObservation(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(observation.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyQuestionnaireResponse(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: questionnaireResponse.identifier?.value,
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
    };
  ...
  public buildKeyDiagnosticReport(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(diagnosticReport.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyDocumentReference(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(documentReference.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyPractitioner(
    ...
    return {
      ...
      identifier: pickIdentifier(practitioner.identifier),
    };
  }
  ...
  public buildKeyPractitionerRole(
    ...
    return {
      ...
      identifier: pickIdentifier(practitionerRole.identifier),
    };
  }
  ...
  public buildKeyOrganization(
    ...
    return {
      ...
      identifier: pickIdentifier(organization.identifier),
    };
  }
  ...
  public buildKeyRelatedPerson(
    ...
    return {
      ...
      identifier: pickIdentifier(relatedPerson.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
    };
  ...
  public buildKeySpecimen(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(specimen.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyCarePlan(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(carePlan.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyGoal(reference: Reference, goal: Goal): ResourceAndKey {
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(goal.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyTask(reference: Reference, task: Task): ResourceAndKey {
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(task.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyFamilyMemberHistory(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(familyMemberHistory.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
  ...
  public buildKeyClaim(reference: Reference, claim: Claim): ResourceAndKey {
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(claim.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
    };
  ...
  public buildKeyExplanationOfBenefit(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(eob.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
    };
  ...
  public buildKeyCoverage(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(coverage.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
    };
  ...
  public buildKeyDevice(reference: Reference, device: Device): ResourceAndKey {
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(device.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
      text: cleanText(
  ...
  public buildKeyLocation(
    ...
    const key: ResourceAndKey = {
      ...
      identifier: pickIdentifier(location.identifier),
      primaryCodeSystem: primaryCoding?.system,
      primaryCode: cleanCode(primaryCoding),
      primaryCoding,
